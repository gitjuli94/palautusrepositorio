...
class TestKauppa(unittest.TestCase):
    ...
    def test_asiointi_oikeilla_arvoilla(self):
    ...
    def test_asiointi_kaksi_eri_tuotetta(self):
    ...
    def test_asiointi_samaa_eri_tuotetta(self):
    ...
    def test_asiointi_lisaa_myos_loppunut_tuote(self):
    ...
    def test_tekee_uuden_viitenumeron(self):
        ...
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("jaska", "54321")
        ...
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("irma", "99999")

        self.assertEqual(self.viitegeneraattori_mock.uusi.call_count, 3)

    def test_asiointi_poista_korista(self):
